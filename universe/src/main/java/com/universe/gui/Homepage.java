...
contentPane.add(sidebar);
		...
		rightFriendsListPanel.setLayout(new BoxLayout(rightFriendsListPanel, BoxLayout.Y_AXIS)); // BoxLayout for
																									// dynamic height
	...
	private JPanel createSidebar(JFrame parentFrame) {
		...
		// Add icons and actions to the sidebar
		addSidebarIcon(sidebar, "src/main/resources/icons/home.png", "Home", 100, e -> {
			...
			parentFrame.dispose(); // Close current page
		});
		addSidebarIcon(sidebar, "src/main/resources/icons/messages.png", "Chat", 170, e -> {
			...
			EventQueue.invokeLater(() -> {
				...
				messagingPage.setLocationRelativeTo(null); // Center the new window
			});
			parentFrame.dispose(); // Close current page
		});
		addSidebarIcon(sidebar, "src/main/resources/icons/notifications.png", "Notifications", 240,
				e -> JOptionPane.showMessageDialog(parentFrame, "Notifications clicked!"));
		addSidebarIcon(sidebar, "src/main/resources/icons/community.png", "Community", 310,
				e -> JOptionPane.showMessageDialog(parentFrame, "Community clicked!"));
		addSidebarIcon(sidebar, "src/main/resources/icons/settings.png", "Settings", 380,
				e -> JOptionPane.showMessageDialog(parentFrame, "Settings clicked!"));
		addSidebarIcon(sidebar, "src/main/resources/icons/leave.png", "Logout", 450, e -> {
			int confirm = JOptionPane.showConfirmDialog(parentFrame, "Are you sure you want to exit?", "Exit Confirmation",
	...
	private void addToRightFriendsPanel(UserProfile user) {
		...
		messageButton
				.addActionListener(e -> JOptionPane.showMessageDialog(null, "Messaging " + user.getUsername() + "!"));
